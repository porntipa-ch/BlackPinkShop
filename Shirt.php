...
<body>
    ...
    $all_cart1 = "SELECT * FROM `cart` WHERE username ='$user'";
    $total = mysqli_query($conn,$all_cart1);
    $num_row1 = mysqli_num_rows($total);
    echo $num_row1;
    ?>
    <nav>
        ...
        <ul>
            ...
            <li><a class="active" href="./Shirt.php"><i class="fas fa-tshirt"></i> Shirt</a></li>
            <li><a href="./Pants.php"><i class="fas fa-socks"></i> Pants</a></li>
            <li><a href="./Other.php"><i class="fas fa-list"></i> Other</a></li>
            <li><a href="./mycart.php"><i class="fas fa-shopping-cart"></i> My Cart (<?php echo $num_row1; ?>)</a></li>
        ...
        ?>
            <form action="./manage_cart.php" method="POST">
                <div class="card" style="width: 18rem;">
                    <img src="<?php echo $row[3]; ?>" class="card-img-top" style="height: 300px;">
                    <div class="card-body">
